  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">
        Di halaman ini Anda dapat membuat Lokal baru
      </p>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="<?= base_url('lokal/tambahlokal'); ?>" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="form-group col-lg-4 col-sm-12 col-md-12">
                    ...
                    <input type="text" class="form-control" name="callsign" autofocus value="<?= set_value('callsign'); ?>" placeholder="Callsign">
