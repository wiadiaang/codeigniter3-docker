      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="<?= base_url('peserta/edit/' . $staff->id_staff); ?>" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="form-group col-lg-4 col-sm-12 col-md-12">
                    ...
                    <input type="text" class="form-control" name="callsign" autofocus value="<?= $staff->callsign; ?>">
