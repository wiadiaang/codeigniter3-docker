                  ...
                  <tbody>
                    ...
                    foreach ($staff as $key => $value) : ?>
                      <tr>
                        ...
                        <td class="text-center" class="text-dark"><?= $value->nama_staff; ?></a>
                          <div class="table-links">
                            <div class="bullet"></div>
                            <a href="<?= base_url('peserta/edit/' . $value->id_staff); ?>">Edit</a>
                            <div class="bullet"></div>
                        ...
                        <td class="text-center"><?= $value->ukuran_kaos; ?></td>
                        <!-- <a href="<?= base_url('peserta/detail/' . $value->id_staff); ?>"  -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="<?= base_url('peserta/hapus/' . $value->id_staff); ?>">
