  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">
        Di halaman ini Anda dapat membuat Peserta baru
      </p>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="<?= base_url('peserta/tambahpeserta'); ?>" enctype="multipart/form-data">
                <div class="row">
                  <div class="form-group col-lg-4 col-sm-12 col-md-12">
                    <label class="">Nama Peserta</label>
                    <input type="text" class="form-control" name="name" autofocus value="<?= set_value('name'); ?>">
                    <small class="text-danger "><?= form_error('name') ?></small>
                  </div>
                  <div class="form-group col-lg-4 col-sm-12 col-md-12">
                    <label class="">Callsign</label>
                    <input type="text" class="form-control" name="callsign" autofocus value="<?= set_value('callsign'); ?>">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-4 col-sm-12 col-md-12">
                    ...
                    <select name="ukurankaos" class="form-control selectric">
