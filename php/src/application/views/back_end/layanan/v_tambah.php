  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">
        Di halaman ini Anda dapat membuat Lomba baru
      </p>
            ...
            <div class="card-body">
              <form method="POST" action="<?= base_url('layanan/tambah'); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-form-label ">Keterangan Lomba</label>
                  <div class="">
                    <textarea name="isi" id="berita" value="<?= set_value('isi'); ?>">Keterangan Lomba</textarea>
